...
/**
 * RabbitMQ Publisher – shared infrastructure adapter implementing IMessagePublisher.
 *
 ...
 *
 * Registered as a global provider so all modules can publish to the worker queue
